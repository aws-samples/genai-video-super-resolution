...
docker_image_base_name="genai-swinir2-4x-super-resolution"
...
local_docker_image_name="${docker_image_base_name}:trt"
docker build -t ${local_docker_image_name} --build-arg="AWS_REGION=${aws_region_name}" . -f Dockerfile.swinir2-tensorrt.gpu
